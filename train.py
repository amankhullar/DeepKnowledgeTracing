...
def main(train_file_path, batch_size):
    ...
    train_skill_loader = torch.utils.data.DataLoader(skill_dataset, batch_size=batch_size, shuffle=False, num_workers=2)
    ...
    for (student, student_orig) in train_skill_loader:
        ...
        print("Original student size is : {}".format((student_orig.size())))
        break
